export const pt = {
    ...
    home: {
        title: "A minha experiência em programção",
        titledescription: `"Descobri na programação uma paixão por inovar e aplicar as minhas
        habilidades em soluções impactantes!"`,
        question1: "Como é que tudo começou?",
    ...
    about: {
        ...
        answer2: "A escolha pela programação é fruto do meu desejo ardente de materializar conceitos e ideias de maneira tangível. Vejo na programação não apenas uma linguagem de código, mas uma ferramenta poderosa para dar vida às minhas visões criativas. Acredito que através da programação, posso não apenas expressar minha criatividade, mas também enfrentar desafios complexos e construir soluções impactantes."
    },
    contact: {
        title: "Contactos",
        email: "Email",
    ...
    notfound: {
        ...
        btn: "Voltar para a página principal!"
    },
    footer: {
...
export const eng = {
    ...
    home: {
        ...
        titledescription: `"I discovered a passion for innovation and applying my skills to impactful solutions through programming!"`,
        question1: "How did it all begin?",
    ...
    about: {
        ...
        answer2: "The choice for programming is the result of my burning desire to materialize concepts and ideas in a tangible way. I see programming not just as a code language but as a powerful tool to bring my creative visions to life. I believe that through programming, I can not only express my creativity but also tackle complex challenges and build impactful solutions."
    },
    contact: {
        title: "Contacts",
        email: "Email",
    ...
    notfound: {
        ...
        btn: "Back to the main page!"
    },
    footer: {
        title: "Portfolio - Pedro Martins"
    }
